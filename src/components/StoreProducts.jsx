...
function StoreProducts({ product }) {
  ...
  return (
    <>
      <div
        className="ms-3 p-3 mt-3 shadow-lg position-relative  d-flex flex-column gap-2 justify-content-around border border-dark rounded-3"
        ...
        <div className="d-flex gap-3">
          <button className="p-1 rounded-3" style={{ width: "100%" }}>
            <Link
              ...
              className="text-decoration-none text-dark w-full d-block"
            >
              View Details
            </Link>
          </button>
